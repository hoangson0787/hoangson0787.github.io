...
:::
::: {.column width="80%"}
![Chu kỳ sinh học - [chronobiology](https://en.wikipedia.org/wiki/Chronobiology)](./Images/Biological_clock_human.svg){width="90%"}
:::
::::
...
::: {.callout-important title="pulsatile drug deliver"}
...
```{mermaid}
flowchart LR
  A[INTELLIGENT DRUG DELIVERY SYSTEMS] --> B1(Pulsatile Systems)
  B1 --> C1(System based on osmosis)
  B1 --> C2(System based on capsule)
  B1 --> C3(System with erodible, soluble or rupturable membrane)
  B1 --> C4(System with change in membrane permeabilit)
```
...
flowchart LR
  A[INTELLIGENT DRUG DELIVERY SYSTEMS] --> B1(Pulsatile Systems)
  B1 --> C1(Magnetically Modulated Systems)
  B1 --> C2(Ultrasonically Modulated Systems)
  B1 --> C3(Electrically Regulated System)
  B1 --> C4(Photoresponsive Systems)
  A --> B2(Responsive Systems)
  B2 --> D1(Temperature-Sensitive Systems)
  B2 --> D2(Systems Sensitive to pH)
  B2 --> D3(Inflammation-Responsive Systems)
  B2 --> D4(Glucose and Other Saccharide-Sensitive Polymers)
  A --> B3(Systems Utilizing Enzymes)
  B3 --> E1( Urea Responsive Delivery)
  B3 --> E2( Glucose-Responsive Insulin Delivery)
  B3 --> E3(Morphine-Triggered Naltrexone Delivery Systems)
  A --> B4(Systems Utilizing Antibody Interactions)
  A --> B5(Systems Utilizing Chelation)
```
:::
::::
