...
3. Vận dụng được kiến thức để giải thích vai trò từng thành phần trong công thức thuốc của một số chế phẩm thuộc hệ giải phóng kiểm soát, nguyên tắc bào chế, cơ chế giải phóng dược chất tir hệ thuốc có công thức tương ứng.
...
flowchart LR
  ...
  B1 --> C2
```
![](../BaoCheCacDangDacBiet/Images/Kiemsoathoatan.jpg)

::: 
::: {.column width="40%"}
![](../BaoCheCacDangDacBiet/Images/Kiemsoatgiaiphong.jpg)
:::
::::
...
**Cấu trúc hệ thuốc:** Được bao lớp màng kiểm soát giải phóng. Lớp màng polymer không tan trong dịch sinh học kiểm soát giải phóng dược chất dựa trên các kênh khuyếch tán được tạo ra trong lớp bề dày của màng khi tiếp xúc trực tiếp với môi trường sinh học.
...
![Drug release is controlled by a semi-permeable membrane. Diffusion through membrane limits the release rate](../BaoCheCacDangDacBiet/Images/Semi.png)
:::

::::

### Cơ chế và mô hình động học
...
::: {.callout-important title="Cấu trúc hệ thuốc"}
 Hệ thuốc chứa dược chất được bao màng polymer chậm hòa tan bị mòn dân trong môi trường dịch sinh học, màng polymer thân nước trương nở gel tạo ra hàng rao kiểm soát làm chậm và kéo dài quá trình giải phóng. Màng bao có thể có độ dày mỏng khác nhau: 1 lớp bao ngoài hệ chứa dược chất hoặc bao từng lớp màng xen kẽ lớp dược chất tọa ra sự giải phóng ngắt quãng.
:::
...
Phần phần dược chất trong lớp màng gel được hòa tan khuếch tán chậm qua hàng rào gel và lớp dịch có độ nhớt cao và được giải phóng ra môi trường cùng sự hòa tan dần của lớp gel, lớp dịch đậm đặc polymer

Dược chất được hòa tan ở giai đoạn cuối cùng lớp dịch polymer đã hòa tan khuyêsch tán vào môi trường sin học

![Nonporous semi-permeable membranes:  Drug diffusion through swollen polymer membrane](../BaoCheCacDangDacBiet/Images/swollen.png)
...
Dược chất phân tán trong cốt không tan trong môi trường sinh học. Cốt đóng vai trò như khung giá mang thuốc. Sau khi tiếp xúc với nước của môi trường. dược chất được hòa tan trong các kênh nước được tạo ra trong cốt và khuyếch tán giải phóng ra khỏi hệ thuosc. Cốt sơ nước có thể bị ăn mòn trong đường tiêu hóa để giải phóng dược chất. 
:::
...
[](../BaoCheCacDangDacBiet/Images/Case1.png)
...
![](../BaoCheCacDangDacBiet/Images/OsmoticDrug.png)
...
- Hệ thơm thẩm thấy tự tạo lỗ xốp: Nươc tieeos xuasc màng bao, hòa tan các chất tan là tá dược tạo lỗ xốp trong bằng bao, tạo hệ vi lỗ. Nước qua màng bán thấm và vi lỗ xốp vào trong hệ hòa tan dược chất và chất tan có trong hệ thuốc tạo áp suất thẩm thấu lớn. Dung dịch được bơm đẩy ra môi trường qua hệ vi miệng lỗ giải phóng đên skhi cần 
...
Từ dữ liệu độ hòa tan tỉnh chỉ số khác nhau (fl) và chỉ số giống nhau (12) theo công thức:

f = 50. logarit +(1/n) (RT) 100
...
Thường dùng phương pháp xác định các thông số được động học (Coax. Tmax.

AUC) để đánh giá sinh khả dụng in vivo. Các cơ quan quản lý FDA (Hoa Kỳ) hoặc ASEAN, Châu Âu... đã đưa ra các quy định hướng dẫn cụ thể về các nội dung:
...
### Đành giả sinh khả dụng

Xác định các thông số dược động học cơ bản:

Cmax và Tmax : số liệu thu được trực tiếp từ kết quả thí nghiệm.

AUCo-tu (diện tích dưới đường cong nồng độ - thời gian từ thời điểm 0 đền thời điểm t) được tỉnh theo phương pháp hình thang, với ta là thời điểm lấy mẫu cuối cùng có thẻ định lượng được.

AUCox (diện tích dưới đường cong nồng độ - thời gian từ điểm 0 đến vô cùng) được tỉnh toán theo công thức:

AUCO-AUCO-tn + Con/z

Trong đó:

Ca - Nồng độ của thuốc tại thời điểm lấy mẫu cuối cùng

12 – Hằng số tốc độ thải trừ (hệ số góc đường hồi qui giữa 1g(nồng độ] và thời gian)

### Đánh giá tương đương sinh học

Nghiên cứu chèo, đơn liễu, hai thuốc, hai giai đoạn, hai trình tự thử thuốc với

Cmax. AUC và MRT (số liệu có thể chuyển logarit):

Phân tích phương sai đánh giá ảnh hưởng của các yếu tố như trình tự, giai đoạn, thuốc, cả thể tới kết qua thư nghiệm.

Tỉnh khoảng tin cậy 90% của sự chênh lệch giữa giá trị trung bình của thuốc thửvà thuốc đối chiếu. Nếu giới hạn khoảng tin cậy nằm trong khoảng 80-125% thi

hai chế phẩm được coi như là tương đương sinh học (khi tỉnh dạng logarit).
