...
== 4.1 Giới thiệu
<giới-thiệu>
Dung môi rất cần thiết trong việc chiết xuất các hợp chất từ tự nhiên. Chiết xuất Soxhlet, chiết ngâm và lắc phân đoạn lỏng-lỏng là các ví dụ về sử dụng dung môi để thu được hoạt chất từ các mô thực vật. Sử dụng các phương pháp chiết xuất xanh như vi sóng, siêu âm giúp giảm lượng dung môi sử dụng, giảm thời gian chiết xuất và nâng cao hiệu quả chiết xuất. Các phương pháp này đều đỏi hỏi sử dụng dung môi để hòa tan hoạt chất, tách ra khỏi tế bào thực vật. Sự đa dạng của thành phần hóa học trong thảo dược cũng như phức tạp về tính chất hóa lý do tương tác giữa các thành phần dẫn đến khó khăn lựa chọn dung môi. Mong muốn một dung môi hiệu quả trong quá trình chiết xuất nhất định cần quan tâm tới các đặc tính như tính phân cực, khả năng truyền nhiệt, khả năng hòa tan, độc tính và các thông số hóa lý, bao gồm nhiệt độ sôi, độ nhớt và mật độ phân tử \[3\].~Một chất dạng lỏng, khí hoặc siêu tới hạn có thể đóng vai trò là dung môi trong các ứng dụng thực tế. Bên cạnh khả năng chiết xuất, sự kết hợp ngay quy trình bào chế có thể giảm giá thành sản xuất như một dung môi bào chế với dạng tiêm, dạng uống dung dịch hoặc nhũ tương. Với quy trình này, dung môi nước thường được lựa chọn khi chi phí thấp, dễ lọc, an toàn với người sử dụng và thân thiện với môi trường. Ngoài ra, các quy trình có kết tinh hoặc cần lọc thì nước thuận lợi hơn do phù hợp với các dạng thùng chứa và nguyên liệu thùng chứa. Ở nhiệt độ phòng, nước bay hơi thấp do nhiệt độ bay hơi tại 100$""^o C$. Sử dụng nước trong quá trình chiết xuất giúp giá thành sản xuất thấp. Cũng có vài nhược điểm với dung môi này. Điểm sôi cao dẫn đến nếu sản xuất cần gia nhiệt để chiết hoặc loại bỏ dung môi trong quá trình sản xuất cần năng lượng lớn hơn. Một số nguồn cung nước sạch tại một số nơi trên thế giời còn hạn chế. Khả năng thấm nước trên một số nguyên liệu là không tốt do đó các nhà kha học tập trung vào nghiên cứu các loại dung môi mới có đặc tính giống nước nhưng khắc phục được các nhược điểm trên. \[4\]. Phần lớn các dung môi hữu cơ thông thường trong chiết xuất được phân loại vào nhóm các hợp chất hữu cơ dễ bay hơi (volatile organic compound-VOC). Theo quy tắc Q3C của Hội đồng Quốc tế về Hài hòa hóa (The International Council for Harmonization - ICH) phân loại các dung môi thông thường thành một trong ba nhóm (Loại 1, Loại 2 hoặc Loại 3) như được minh họa trong hình @Fig:Q3CICH. Bên cạnh là dung môi chiết, các dung môi hữu cơ này có một số vai trò khác nhua khả năng tẩy rửa, làm lanh \[5\]. Nhiệt độ bay hơi thấp dẫn tới dễ cháy nổ trong quá trình sử dụng. Ngoài ra, do có đặc tính dược lý riêng dẫn tới người sử dụng có thể bị ảnh hưởng tới sức khỏe. Tác động môi trường của các VOC là cần xem xét tới khi lựa chọn để sản xuất. Nếu dung môi hữu cơ là chất lỏng siêu tới hạn là $C O_2$ thì đây là nguyên nhân gây ra hiện tượng biến đổi khí hậu. #box(image("../graphics/Fig51.png"))

Trong hơn thập kỷ qua, ngành công nghiệp dược phẩn cố gắng phát triển các dung môi thân thiện hơn với môi trường. Trọng tâm quá trình này các quy trình xanh trong hóa học. Các lĩnh vực nghiên cứu trong hóa học được đề cập trong bảng và hình @Fig:Greenprinciples. Đây là quy định về đăng ký, đánh giá, cấp phép và hạn chế hóa chất trong 12 nguyên tắc của hóa học xanh. Dung môi xanh được mong muốn là có độc tính tối thiểu, không bắt lửa, ổn định, không có khả năng gây đột biến và sẵn có. Chúng phải đảm bảo chi phí sản xuất thấp và dễ dàng vận chuyển. #box(image("../graphics/Fig52.png"))
...
#figure(
  align(center)[#table(
    ...
    table.header([STT], [Nguyên tắc], [Mô tả],),
    table.hline(),
